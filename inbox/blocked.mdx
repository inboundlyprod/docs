...
<video autoplay muted loop playsinline className="w-full aspect-video" src="/videos/guides_block_lead.mp4" />
...
<video autoplay muted loop playsinline className="w-full aspect-video" src="/videos/guides_unblock_lead.mp4" />

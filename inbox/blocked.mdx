...
<Info>Blocking a user within Inboundly does not affect their status on  X/Twitter in any way. It does not block them on  X/Twitter, remove their message from your  X/Twitter inbox, or have any impact on your interactions with them outside of Inboundly.</Info>

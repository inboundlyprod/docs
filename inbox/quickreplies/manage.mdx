...
<video autoplay muted loop playsinline className="w-full aspect-video" src="/videos/guides_createqr.mp4" />
...
<video autoplay muted loop playsinline className="w-full aspect-video" src="/videos/guides_editqr.mp4" />

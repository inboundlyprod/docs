...
<video autoplay muted loop playsinline className="w-full aspect-video" src="/videos/guides_mark_unread.mp4" />
...
<Info>Marking messages as unread within Inboundly does not affect Twitter in any way. You can read the message within Inboundly without sending a "read receipt" on Twitter.</Info>
